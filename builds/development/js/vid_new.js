...
function introscreen() {
    ...
    $("#overlay").fadeIn(1000);
    $("#overlay").append("<div class='intro'><div class='movie_h1'>" + intro_header + "</div><p class='feed_txt'>" + intro_text + "</p><div class='btn btn-default btn-lg introknap'>" + intro_knap + "</div></div>");
